...
parser.add_argument('--manifold', type=str2bool, default=True, help = 'Euclidean manifold is false')
...
#from optimizer.LrSchedule import *
...
print("The curvarture parameter c is {}".format(gnn_param['c']))
print("The dimension of feature is {}".format(gnn_param['dim_out']))
...
optimizer = getattr(optimizers, train_param['optimizer'])(params=model.parameters(), lr = train_param['lr'])
lr_scheduler = torch.optim.lr_scheduler.StepLR(
        optimizer,
        step_size=int(train_param['lr_reduce_freq']),
