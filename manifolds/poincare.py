...
class PoincareBall(Manifold):
    ...
    def logmap0(self, p, c):
        ...
        #print('p_norm: ', p_norm[16])
        #print('sqrt_c: ', sqrt_c)
        #print('sqrt_c * p_norm: ', (sqrt_c * p_norm)[16])
        #print('artanh(sqrt_c * p_norm): ', artanh(sqrt_c * p_norm)[16])
        scale = 1. / sqrt_c * artanh(sqrt_c * p_norm) / p_norm
        #print('scale:', scale[16])
        return scale * p
    ...
    def _mobius_pointwise_mul(w: torch.Tensor, x: torch.Tensor, k: torch.Tensor, dim: int =-1):
        ...
        res_c = tanh(wx_norm / x_norm * artanh(x_norm, k), k) * (wx / wx_norm)
